...
$produits = getFavoris($pdo, $_SESSION['user_id']);
...
<?php else: ?>
    <div class="empty-state">
        ...
        <p>Vous n'avez aucun script en favoris.</p>
        <a href="produits.php" class="btn-shop btn-shop-primary" style="margin-top: 20px;">Explorer les scripts</a>
    </div>
<?php endif; ?>
